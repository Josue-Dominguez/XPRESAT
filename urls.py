...
urlpatterns = [
    ...
    #path('mis_publicaciones_recientes/', MisPublicacionesRecientesView.as_view(), name='mis_publicaciones_recientes'),
    #path('publicaciones_recientes/<str:username>/', PublicacionesRecientesView.as_view(), name='publicaciones_recientes'),
